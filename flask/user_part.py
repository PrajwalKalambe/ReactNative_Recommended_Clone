...
def detect_feature_from_local(uri):
    Output_list=[]
    l=''
    ...
    return Output_list, l   

def detect_feature_from_url(uri):
    Output_list=[]
    client = vision.ImageAnnotatorClient()
...
def visionA():
    ...
    if(request.method=='POST'):
        ...
        if(is_url_image(projectpath)):
            ...
            a=detect_feature_from_url(projectpath) 
